<%@ Page Title="List View Data List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AlbumDetails.aspx.cs" Inherits="WebApp.SamplePages.AlbumDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <asp:GridView ID="TrackOfAlbums" runat="server" 
            DataSourceID="AlbumTrackODS" AutoGenerateColumns="false" AllowPaging="True" OnSelectedIndexChanged="TrackOfAlbums_SelectedIndexChanged">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Time(Milliseconds)">
                    <ItemTemplate>
